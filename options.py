...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--display', default=1, action='store_true', help='Use visdom.')
        ...
        self.parser.add_argument('--abnormal_class', default=5, help='Anomaly class idx for mnist and cifar datasets')
    ...
    def parse(self):
        ...
        if self.opt.name == 'experiment_name':
            ...
            self.opt.name = "%s/%s" % (self.opt.model, self.opt.name)
